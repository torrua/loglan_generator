...
class DefinitionFormatter:
    ...
    def tagged_word_origin_x(self, tag: str) -> str:
        ...
        """
        return tag % self.d.source_word.origin_x \
            if (
                self.d.source_word.origin_x and
                self.d.source_word.type.group == "Cpx"
        ) else str()
    ...
    def tagged_word_name(self, tag: str) -> str:
        ...
        """
        return tag % self.d.source_word.name if not self.d.usage \
